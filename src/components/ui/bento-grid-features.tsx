  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-16 px-4 pb-20 relative z-20">
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 lg:gap-6">
        ...
        <div className="col-span-1 md:col-span-2 bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 flex flex-col items-center justify-center min-h-[300px] relative overflow-hidden group hover:border-white/10 transition-colors">
        ...
        <div className="col-span-1 md:col-span-2 bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 flex flex-col items-center justify-center text-center min-h-[300px] relative overflow-hidden group hover:border-white/10 transition-colors">
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
        ...
        <div className="col-span-1 md:col-span-2 bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 flex flex-col min-h-[300px] relative overflow-hidden group hover:border-white/10 transition-colors">
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
        ...
        <div className="col-span-1 md:col-span-3 bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 flex flex-col md:flex-row items-center gap-8 min-h-[250px] relative overflow-hidden group hover:border-white/10 transition-colors">
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
